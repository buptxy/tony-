...
var synDetectFace = function(zjn,imgbase64) { //人脸识别API
  ...
  let params = '{"ProjectId":"104514","ModelId":"'+zjn+'","Image":"' + imgbase64 + '","RspImgType":"url"}' //拼接参数
...
exports.main = async(event, context) => {
  ...
  const zjn=[event.aa]
  datas = await synDetectFace(zjn,imgbase64) //调用异步函数，向腾讯云API发起人脸融合请求
